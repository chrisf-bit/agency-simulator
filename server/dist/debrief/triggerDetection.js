...
exports.detectTriggers = detectTriggers;
// =============================================================================
...
function detectTriggers(team, gameContext) {
    const triggers = [];
    ...
    const heavyDiscountQuarters = discountsByQuarter.filter(d => d.avgDiscount > THRESHOLDS.HEAVY_DISCOUNT_PCT);
    triggers.push({
...
function getDiscountsByQuarter(team) {
    const results = [];
    // Current inputs
...
function getPitchRatesByQuarter(team, gameContext) {
    const results = [];
...
function getQualityChoices(team) {
    const results = [];
    // Current inputs
...
function getInvestmentsByQuarter(team) {
    const results = [];
    // From current inputs
...
function getWellbeingByQuarter(team) {
    const results = [];
    // Current inputs
...
function detectBurnoutSpiral(history) {
...
function detectBurnoutRecovery(history) {
